...
class _LiveCallScreenState extends ConsumerState<LiveCallScreen> {
  ...
  Widget _failure(VoixColors c) {
    final (title, detail) = switch (_voice.error) {
      ...
      VoiceCallError.notSubscribed => (
          'Live voice is part of Premium',
          'Your subscription could not be confirmed. If you have just '
              'subscribed, give it a moment and try again — or use Restore '
              'Purchases on the Premium screen.',
        ),
